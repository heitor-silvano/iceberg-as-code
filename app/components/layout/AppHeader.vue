...
<template>
  <header class="h-12 bg-zinc-950 border-b border-zinc-800/80 px-4 flex items-center justify-between select-none shrink-0 z-20">
    ...
    <div class="flex items-center space-x-3 text-xs">
      <a
        href="https://github.com/heitor-silvano/iceberg-as-code"
        target="_blank"
        rel="noopener noreferrer"
        class="flex items-center space-x-1.5 px-3 py-1.5 bg-zinc-800/80 hover:bg-zinc-700/80 text-zinc-200 rounded-md border border-zinc-700/60 font-medium transition-all hover:border-zinc-600"
        title="Ver no GitHub"
      >
