...
<template>
  <div
    class="h-10 bg-zinc-900 border-b border-zinc-800 flex items-center select-none text-xs shrink-0 overflow-visible z-10">
    <div class="h-full px-3 flex items-center justify-between border-r border-zinc-800/80 shrink-0"
      :style="{ width: `${splitRatio}%` }">
      <div class="flex items-center space-x-2">
        <button type="button" @click="insertTier"
        ...
        <div class="relative">
          <button type="button" @click="isFontDropdownOpen = !isFontDropdownOpen"
    ...
    <div class="h-full px-4 flex items-center justify-between shrink-0" :style="{ width: `${100 - splitRatio}%` }">
      ...
      <div class="flex items-center space-x-4">
        <div class="flex items-center space-x-2">
          ...
          <input type="range" v-model="textAlpha" min="0" max="100"
        ...
        <div class="flex items-center bg-zinc-950 p-0.5 rounded-lg border border-zinc-800">
          <button type="button" @click="previewFont = 'sans'"
          ...
          <button type="button" @click="previewFont = 'mono'"
