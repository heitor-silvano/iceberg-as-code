...
5. **Comunicação Concisa**: Não sumarize códigos ou a documentação inteira para o humano. Apenas aponte os documentos atualizados e solicite aprovação/caminho a seguir.
